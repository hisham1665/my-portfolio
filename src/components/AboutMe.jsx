  ...
  return (
    <section id="about" className="py-12 px-6 md:px-20 bg-[#F0F0EC]  text-violet-700 ">
      ...
      <div className="space-y-5 text-lg leading-relaxed text-gray-500">
        ...
        <p>
            I believe that great software is not just about writing functional code—it's about delivering experiences that users enjoy and trust. I'm deeply motivated by the opportunity to learn from real-world feedback, iterate rapidly, and grow both technically and creatively. Whether I'm working independently or collaborating with a team, I bring a strong work ethic, a problem-solving mindset, and a genuine passion for innovation to every project I take on.
        </p>
      </div>
    </section>
  );
